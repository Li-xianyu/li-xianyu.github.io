...
window.__I18N_DICTIONARIES.en = {
	...
	settings: {
		...
		modulePoolTipHtml: "Use the five summaries below to edit one module at a time. Categories with <span class=\"plus-badge\">+</span> allow custom chips.",
		modulePoolSelectPrompt: "Choose one module above.",
		modulePoolSummaryMeta: "{enabled}/{total} | {status}",
		modulePoolSummaryGroupAria: "B module content summaries",
		modulePoolStatusFull: "All enabled",
		modulePoolStatusRich: "Balanced",
		modulePoolStatusLight: "Few enabled",
		modulePoolStatusNone: "None enabled",
		modulePoolSelectAll: "Select all",
		modulePoolSelectNone: "Select none",
		modulePoolInvert: "Invert",
		modulePoolEnabledSection: "Enabled",
		modulePoolDisabledSection: "Disabled",
		modulePoolEnabledEmpty: "No enabled chips.",
		modulePoolDisabledEmpty: "No disabled chips.",
		...
		activeWeightDecrease: "Decrease instruction weight",
		activeWeightIncrease: "Increase instruction weight",
		activePoolTip: "Prepare the future instruction pool here with the same lightweight structure used in B.",
